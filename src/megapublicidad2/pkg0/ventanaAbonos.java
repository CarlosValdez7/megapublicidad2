...
public class ventanaAbonos extends javax.swing.JFrame {
    ...
    public ventanaAbonos(String totalPago) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(192, 30, 400, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tipoPago = "", entregado = "NO",pagos="";
...
/*        if (ventana.equals("venta")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaAbonos.class  
